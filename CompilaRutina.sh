...
echo ' Compilación ' 
cobc -static $HOME/cobol/fuentes/${prog_name}.cbl -L/home/db2inst1/sqllib/lib64 -ldb2 -O -I /home/forma2/cobol/copys                                           -L/$HOME/cobol/rutinas -o $HOME/cobol/rutinas/${prog_name}
...
if [ -f $HOME/cobol/rutinas/${prog_name}.so  ] 
 then
...
echo ' Compilado  ' 
ls -l $HOME/cobol/rutinas/${prog_name}.so  
